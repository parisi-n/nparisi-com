---
title: "I monasteri, la storia di un popolo, la tradizione in estinzione: fuori da Yerevan"
date: "2026-02-07"
image: "images/sevan-monastery-copertina.webp"

summary : "Yerevan non è che una città, e come tale non rappresentativa nell'insieme di una nazione, per quanto piccola possa essere. E così ci addendriamo con Monia e Spartak, alla guida di una monderna marshrutka — alla scoperta delle tradizioni e della storia perduta del popolo armeno."
...
{{< video src="sevan_lake_view.webm" caption="Vista del Lago Sevan" >}}
...
{{< image src="sevanavank_monastery_4.webp" caption="Monastero di Sevanank" >}}
...
{{< image src="strada_extraurbana_van.webp" alt="Scorcio di strada armena dall'interno della marshrutka" >}}
...
{{< image src="montagne_lontane_2.webp" caption="Cime innevate" type="wide-screen">}}

Scorgiamo anche quel che è a tutti gli effetti una caratteristica dell'Armenia: le sue statue più particolari posizionate nei punti più impensabili, ad ornare le fermate dei bus.

{{< image src="statua_extraurbano.webp" alt="Statua ornamentaria di una fermata dei bus extraurbana" type="wide-screen">}}
...
{{< image src="sevan_lake_2.webp" caption="Lago Sevan" type="wide-screen">}}
...
{{< image src="sevan_lake.webp" alt="Lago Sevan e suoi alberghi" >}}

I _khachkar_ sono elementi iconici della cultura armena e non sono altro che pietre incise a basso-rilievo raffiguranti al centro una croce cristiana che poi viene variamente ornata con disegni a forma di sole o di rosetta.

{{< image src="sevanavank_monastery_inside_2.webp" caption="La natività" >}}
...
* * *
Ci viene fatto notare da Monia come solo l'ossidiana sia tipica dell'Armenia; qualunque altra pietra (come nel caso della foto, la _moon stone_) viene millantata come originaria dell'Armenia (giunta in vari modi — tra cui tramite un meteorite caduto nei pressi del Lago) ma in verità lo è.

{{< image src="stones.webp" alt="Ossidiana ed altre pietre" >}}
...
{{< image src="old_dilijan_sign.webp" alt="Old Dilijan" >}}

Strano a leggersi, incredibile a dirsi — Dilijan conta ad oggi circa 15'000 abitanti!
La nostra prima impressione appena scesi è che ci trovassimo in un paese fantasma, di quelli che via via spariscono nel tempo a causa dello spopolamento progressivo e dell'assenza di servizi…

Invece è più vivo che mai.

{{< image src="old_dilijan_street.webp" caption="Vie del centro storico di Dilijan" >}}

In particolare la _old town_ è stata preservata per essere vetrina e sede di artigiani armeni, espressione della manifattura locale.
...
{{< video src="dilijan_old_town.webm" type="vertical_9x16" >}}
...
Per i più scettici, la _old town_ offre alcune possibilità di mangiare con pochi soldi e di rimanere comunque al suo interno senza necessità di uscire.
La nostra preoccupazione era invece che non trovassimo granchè, motivo per il quale durante il viaggio verso [il lago Sevan](#il-lago-sevan-ed-il-monastero-di-sevanavank) avevamo esplicitamente chiesto di poter pranzare con l'organizzazione mediante apposito modulo che ci era stato chiesto di compilare.
...
Una piacevole esperienza, ma col senno di poi forse sarebbe stato più piacevole rimanere in giro per la _old Dilijan_ e mangiare _street food_.
...
{{< video src="haghartsin_hyperlapse.webm" caption="Hyperlapse del Monastero di Haghartsin" type="vertical_9x16" >}}

Altro complesso di monasteri, composto da tre chiese — ma con una storia e date simili a Sevanavank.

{{< image src="haghartsin_monastery.webp" alt="Complesso di Hanghartsin" >}}
...
{{< image src="haghartsin_monastery_wedding.webp" caption="Matrimonio armeno" >}}
...
{{< image src="goshavank_monastery_hyur_marshrutka.webp" alt="Marshrutka di Hyur con sullo sfondo il monastero di Gosh" >}}
...
{{< image src="goshavank_monastery.webp" caption="Monastero di Gosh" >}}

Ma facciamo un ultimo sforzo e visitiamo il Monastero di Gosh.

Al suo interno sono conservate alcune delle _khachkar_ meglio conservate di tutta l'Armenia.

{{< image src="stones_wall_decorations.webp" caption="Khachkar" >}}
...
{{< image src="goshavank_monastery_decorations.webp" caption="Dettagli" >}}

Non ha delle cinte murarie a differenza di quello di [Haghartsin](#haghartsin-ed-il-monastero) ma, anzi, è circondato da case in cui sembrerebbe svolgersi una vita normalissima ed incurante del gigante storico che hanno la fortuna di ammirare ogni giorno.

{{< image src="goshavank_monastery_writtens.webp" caption="Iscrizioni" >}}

{{< box "blue" >}}
Gli armeni scrivevano scrivevano sulla pietra affinchè le storie resistessero al tempo.

Ancora oggi non tutte le iscrizioni sono state decifrate — nonostante siano scritte in alfabeto armeno — e agli armeni nativi risulta impossibile leggerne il contenuto perchè apparentemente privo di senso.

Dalle poche iscrizioni che si è riusciti a tradurre vengono narrati fatti biblici o contingenti alla società locale durante la realizzazione delle strutture, per rendere indelebili gli avvenimenti.
{{< /box >}}

Oltre alle prezione decorazioni incise con maestria sulla pietra è curioso anche notare come siano stati realizzati certi muri.
Nulla è lasciato al caso, e tutto è stato fatto per celebrare ed esaltare l'arte e glorificare la grandezza di Dio.

{{< image src="stones_wall.webp" caption="Dettagli della pietra" >}}
...
{{< image src="samovar.webp" caption="Semovar" >}}
...
{{< image src="old_houses.webp" alt="Casa abitata in stato di degrato strutturale" >}}
...
{{< image src="post_office_gosh.webp" caption="Ufficio postale di Gosh" >}}

La vita sembra scorrere comunque in quel di Gosh, giorno dopo giorno.

{{< image src="lada_2.webp" caption="Lada" >}}
...
{{< image src="foto_gruppo.webp" caption="Foto di gruppo" type="wide-screen">}}
...
{{< video src="candele_accese.webm" caption="Affinchè non manchi mal la salute — per poter tornare in Armenia" type="vertical_9x16" >}}

Son cosciente di non aver visto che una frazione di quello che una nazione come l'Armenia ha da offrire, così ho deciso di proseguire con lo studio anche dopo tornato in Italia: mi sono iscritto e leggo regolarmente il Reddit {{< external_link "https://www.reddit.com/r/armenia/" "r/armenia" >}} che offre continuamente un punto diverso, un nuovo inizio per quella che è una terra che cerca in tutti i modi la scintilla per innescare il fuoco del cambiamente e voler primeggiare.
