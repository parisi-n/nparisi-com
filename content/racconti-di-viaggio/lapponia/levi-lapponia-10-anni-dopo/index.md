...
{{< image src="casa_neve.webp" alt="" class="" caption="" >}}
...
{{< video src="boarding.webm" class="" caption="" type="wide-screen" >}}
...
Partenza da **Bergamo — Orio al Serio** e arrivo a **Helsinki — Vantaa** con RyanAir; da qui layover di un paio di ore giusto per prenderci il sicuro e partenza per **Oulu**.
...
{{< video src="sboarding.webm" class="" caption="" type="wide-screen" >}}
...
Mi consolo con il fatto che comunque, avendo prenotato con la carta di credito {{< external_link "Platino di American Express METTERE LINK" "LINK ESTERNO" >}}, in caso di problematiche ho un ulteriore scudo protettivo.

{{< image src="macchina_neve.webp" alt="" class="" caption="" >}}
...
{{< image src="macchina_noleggio.webp" alt="" class="" caption="" >}}
...
{{< video src="lampadario_renna.webm" class="" caption="Macabro ma caratteristico lampadario" type="vertical_9x16" >}}
...
{{< video src="pano_hotel.webm" class="" caption="" type="vertical_9x16" >}}
...
{{< video src="strada_lapland.webm" class="" caption="" type="vertical_9x16" >}}
...
{{< youtube id="shorts/Luu_yVSD56g" caption="">}}
...
{{< image src="aurora_boreale_drone.webp" alt="" class="" caption="" >}}
...
{{< image src="drone_strada_lago_ghiacciato.webp" alt="" class="" caption="" >}}
...
{{< image src="paesaggio_nevoso_pomeridiano.webp" alt="" class="" caption="" type="wide-screen" >}}
...
Levi merita tuttavia qualche parola, essendo destinazione del turismo sciistico invernale finlandese e — qualche giorno prima del nostro arrivo — teatro della manifestazione sportiva {{< external_link "The Alpine Ski World Cup" "https://sportpress.international/ski-slalom-levi-2025/" >}}.

{{< image src="tempesta_neve.webp" alt="" class="" caption="" >}}

E' un paese fortemente turistico, probabilmente ultima postazione di civiltà prima della lapponia più sperduta.

{{< image src="strada_neve_drone.webp" alt="" class="" caption="" >}}
...
{{< image src="foresta_innevata.webp" alt="" class="" caption="" >}}
...
{{< image src="preparativi_winterproof.webp" alt="" class="" caption="" >}}
...
{{< image src="motoslitta.webp" alt="" class="" caption="" >}}
...
{{< image src="husky.webp" alt="" class="" caption="" >}}
...
{{< image src="husky_slitta.webp" alt="" class="" caption="" type="wide-screen" >}}
...
{{< image src="husky_slitta_2.webp" alt="" class="" caption="" >}}
...
{{< image src="husky_slitta_3.webp" alt="" class="" caption="" >}}
...
{{< video src="husky.webm" class="" caption="" type="vertical_9x16" >}}
...
{{< video src="renne.webm" class="" caption="" type="vertical_9x16" >}}
...
{{< image src="renna.webp" alt="" class="" caption="" >}}
...
{{< image src="slitta_renne.webp" alt="" class="" caption="" >}}
...
{{< image src="slitta_renne_2.webp" alt="" class="" caption="" >}}
...
{{< image src="passeggiata_neve_farm.webp" alt="" class="" caption="" type="wide-screen" >}}
...
{{< video src="fuoco.webm" class="" caption="" type="vertical_9x16" >}}
...
{{< image src="cena_levi.webp" alt="" class="" caption="" >}}
...
{{< image src="cena_levi_2.webp" alt="" class="" caption="" >}}
...
{{< youtube id="shorts/BzLnbtwey1M" caption="">}}
...
{{< image src="casa_babbo_natale_termometro.webp" alt="" class="" caption="" >}}
...
{{< image src="bus_notte_strada.webp" alt="" class="" caption="" >}}
...
{{< image src="helsinki_station.webp" alt="" class="" caption="" type="wide-screen" >}}
...
{{< image src="helsinki_harbour.webp" alt="" class="" caption="" type="wide-screen" >}}
...
{{< image src="helsinki_catedrale.webp" alt="" class="" caption="" >}}
...
{{< image src="helsinki_public_wc.webp" alt="" class="" caption="" >}}
...
{{< image src="helsinki_tram.webp" alt="" class="" caption="" >}}
...
{{< image src="riga_vie.webp" alt="" class="" caption="" >}}

E Riga d'inverno, senza neve, ammetto sia un po' spoglia.

{{< image src="riga_edificio.webp" alt="" class="" caption="" >}}

Il teatro, i mercatini natalizi delle bancarelle di cibo e ancora una volta la {{< external_link "Piazza della Cattedrale di Riga" "https://maps.app.goo.gl/YtLmGoXLB3P8TpZK9" >}}.

{{< image src="riga_market_food.webp" alt="" class="" caption="" >}}
...
{{< image src="riga_markets.webp" alt="" class="" caption="" >}}

Il cibo però questa volta mi ha un po' deluso: forse per giorno, ma non c'era la **zuppa di pesce**.

{{< image src="riga_segnali_fumo.webp" alt="" class="" caption="" >}}
...
{{< image src="riga_market_food_pano.webp" alt="" class="" caption="" >}}