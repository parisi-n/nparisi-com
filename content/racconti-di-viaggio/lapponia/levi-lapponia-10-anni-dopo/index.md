---
title: "Lapponia, il ritorno: Levi, la corsa sugli husky, la slita delle renne, l'impantanamento. Helsinki e Riga."
date: "2026-01-10"
image: "images/lapland_levi_cover.webp"
video: "video/lapland_levi_cover.webm"
...
categories : [ "racconti-di-viaggio", "finlandia", "repubbliche-baltiche" ]
tags : [ "travel", "finlandia", "riga" ]
...
{{< quote "Il più bel viaggio che abbia mai fatto in assoluto. E a dire che non ci volevo neanche andare!" >}}

{{< capital_letter_open >}}
Iniziava così l' [ultimo post che scrissi ormai quasi 10 anni fa ]({{< ref "/racconti-di-viaggio/lapponia/verso-lapponia-casa-di-babbo-natale/index.md" >}})in occasione del **mio primo viaggio in Lapponia**.
...
Il tutto nasce dal fatto che {{< affiliate_link "frupari-instagram" "@frupari" >}}, all'ormai venderanda età di 32 anni sulle spalle, ancora non aveva visto la neve; quindi quale miglior occasione che Lapponia nel periodo prenatalizio?

{{< image src="casa_neve.webp" alt="Casa con il tetto innevato ed un albero con i rami bianchi nel giardino" caption="" >}}
...
{{< video src="boarding.webm" caption="Fase di boarding sul turboelica" type="wide-screen" >}}
...
Il nostro desiderio era riandare nella Lapponia finlandese, la più famosa — nei pressi delle località di {{< external_link "https://maps.app.goo.gl/LXPwLw5KY7deuo3S6" "Äkäslompolo" >}} che nel frattempo ha raggiunto dei costi spropositati e non congrui con quello che era il nostro budget.

Frughiamo la mappa e ci focalizziamo su {{< external_link "https://maps.app.goo.gl/kJgpS3C2NuzycUQJA" "Levi" >}}: un piccolo villaggio sciistico poco più a nord **e per giunta dotato di aeroporto**.
...
- Day #1: viaggio da _Bergamo — Orio al Serio_ a _Oulu_ via _Helsinki_. Noleggio auto e arrivo a **Levi**;
- Day #2: al mattino giro visita alla **fattoria degli husky e delle renne**; alla sera giro per Levi;
- Day #3: in mattinata partenza per _Rovaniemi_ e il suo **Santa Claus village**. Riconsegna dell'auto in aeroporto ad Oulu e poi **bus notturno da Oulu a Helsinki**;
- Day #4: giro a Helsinki alle prime luci dell'alba e trasbordo in aeroporto per la tratta _Helsinki — Riga_; pomeriggio a [Riga]({{< ref "/racconti-di-viaggio/repubbliche-baltiche/tallinn-riga/ep-3-riga/index.md" >}}) e visita ai [suoi mercatini natalizi]({{< ref "/racconti-di-viaggio/repubbliche-baltiche/vilnius-riga/ep-3-riga/index.md" >}});
- Day #5: viaggio di ritorno _Riga — Bergamo Orio al Serio_

Per la prima volta nella storia di questo blog — la narrazione non sarà per capitoli ma tutta in un unico post: son posti di cui abbiamo già parlato a lungo in passato, ma mi piaceva fare comunque un _recap_ del viaggio a futura memoria.

### Aereo ✈️

Da _Bergamo — Orio al Serio_ parte trisettimanalmente un volo per **Rovaniemi**, ma a noi sembrava un modo troppo semplice per arrivarci… e tra le varie possibilità per arrivarci optiamo per quella più complessa.
...
{{< youtube id="wTbUUlwfAfE" caption="Pista di decollo">}}
...
{{< video src="sboarding.webm" caption="Atterrati a Oulu a notte fonda (le 15)" type="wide-screen" >}}

### Auto a noleggio 🚘

Noleggiamo un auto presso {{< external_link "https://maps.app.goo.gl/igWuwFP4v9VfMhSc7" "GreenMotion" >}} attraverso un aggregatore di _rent-a-car_ e solo poche ore prima mi rendo conto di quanto sia recensito male su Google Maps: al momento della prenotazione mi son lasciato abbindolare dal prezzo senza verificare le recensioni (che non è nemmeno da me!) ed ora inizio ad avere qualche remora...ma ormai è tardi per cancellare.
Mi consolo con il fatto che comunque, avendo prenotato con la carta di credito {{< affiliate_link "amex" "Platino di American Express" >}}, in caso di problematiche ho un ulteriore scudo protettivo.

{{< image src="macchina_neve.webp" alt="Toyota Yaris con il cofano posteriore innevato in una strada innevata" caption="" >}}
...
Sono le 16,20 ma la notte è fonda — tanto da sembrare notte inoltrata. Per le strade pochissime auto, tanto da confermare la percezione per cui sia già "tardissimo", ed un po' la cosa ci instilla una lieve quota di _ansia_ sull'arrivare quanto prima a destinazione.

{{< image src="macchina_noleggio.webp" alt="Toyota Yaris, vista di fronte e dal basso in una piazzola innevata" caption="" >}}

### Hotel

Per la nostra permanenza a Levi optiamo per il {{< external_link "https://maps.app.goo.gl/AiXuedCBBpw7dVZbA" "Lapland Hotel" >}}: volevamo che l'esperienza autentica della Lapponia proseguisse anche una volta tornati dalle escursioni, e quale miglior esperienza di una stanza completamente in legno, con sauna (che poi non avremo tempo di usare… 😁) — e con odore di legno silvestre percepibile appena varcata la soglia.

{{< video src="lampadario_renna.webm" caption="Macabro ma caratteristico lampadario" type="vertical_9x16" >}}

Senza contare che cercavamo non solo un posto in cui dormire, ma eventualmente un posto in cui poter cucinare anche qualcosa di _local_ in base ai nostri desideri.

Ci assicuriamo altresì che la reception riesca a garantirci il _check-in_ oltre l'orario indicato su _Booking_ e per questo optiamo per una _reception aperta 24/24_.

{{< video src="pano_hotel.webm" caption="Per le vie del resort" type="vertical_9x16" >}}

## Da Oulu a Levi

Ci lasciamo alle spalle la periferia di Oulu e percorriamo una piacevole _superstrada_ con due corsie per senso di marcia che ci fa ben sperare sulla strada e che ci accompagnerà fino a {{< external_link "https://maps.app.goo.gl/FdF59WmDZM38JeH66" "Keminaa" >}} (in cui arriviamo alle 19 circa)…

Da _Keminaa_ fino a {{< external_link "https://maps.app.goo.gl/4S9EkFGB8UcxEKMB7" "Rovaniemi" >}} la strada si fa a una singola corsia per senso di marcia, ma le corsie sono larghe e ben segnalate; non nevica più — ma la stanchezza indotta dal buio pesto e dai fari dell'auto che non illuminano come desiderato ci porta a fare il primo cambio autista ed è la volta di {{< affiliate_link "washington-instagram" "@washington_giò" >}}.

{{< video src="strada_lapland.webm" caption="POV alla guida nelle strade della Lapponia" type="vertical_9x16" >}}

Da _Rovaniemi_ a _Levi_ preparatevi ad una strada paragonabile alle nostre **strade provinciali**: strette, mal segnalate, con ripetuti incroci — ed in cui dovrete rallentare ad ogni auto che vi verrà contromano.
...
{{< youtube id="Luu_yVSD56g" caption="Renne selvatiche">}}

{{< box "orange" >}}
Soprattutto la notte il rischio che la strada sia attraversata da una o più renne è concreto.

In caso ci si trovi in zone _rurali_ questo rischio è ancora maggiore per cui viene ripetutamente consigliato, perfino dal noleggiatore al momento della presa in consegna dell'auto, di procedere con cautela considerata la zona rurale verso cui volevamo addentrarci.
{{< /box >}}
...
{{< image src="aurora_boreale_drone.webp" alt="" caption="Aurora boreale" >}}

Ma la strada è ancora lunga e dopo un nuovo doppio cambio autista la decisione: per una maggiore sicurezza inizierà a guidare {{< affiliate_link "frupari-instagram" "@frupari" >}} che al momento della prenotazione non era stata inserita tra gli autisti assicurati ma che, considerato il grado di stanchezza subentrante — si rivelava essere la scelta più saggia ed azzeccata.

Guiderà anche lei per quasi un'ora e mezza

Arriviamo a Levi — nel **Lapland hotel** — che sono quasi le 23.30.

{{< image src="drone_strada_lago_ghiacciato.webp" alt="Foto stata con il drone in cui si vede una strada doppia corsia e a destra il lago ghiacciato innevato" caption="" >}}
...
{{< image src="paesaggio_nevoso_pomeridiano.webp" alt="Paesaggio di campagna con lampioni in mezzo alla neve" caption="" type="wide-screen" >}}
...
Levi merita tuttavia qualche parola, essendo destinazione del turismo sciistico invernale finlandese e — qualche giorno prima del nostro arrivo — teatro della manifestazione sportiva {{< external_link "https://sportpress.international/ski-slalom-levi-2025/" "The Alpine Ski World Cup" >}}.

{{< image src="tempesta_neve.webp" alt="" caption="Tempesta di neve" >}}

E' un paese fortemente turistico, probabilmente ultima postazione di civiltà prima della lapponia più sperduta.

{{< image src="strada_neve_drone.webp" alt="Foto dal drone in cui si vede una strada e i lati foreste di conifere" caption="" >}}
...
{{< image src="tetto_neve.webp" alt="tetto di casa con sopra la neve è un luminaria a filo sui suoi margini" caption="Dettagli" >}}

Tutto molto bello, tutto molto fiabesco. Ogni volta la sensazione è la stessa, e sembra di vivere in un sogno.

{{< video src="pano_auto.webm" caption="POV: sei nel mezzo delle campagne lapponi" type="vertical_9x16" >}}
...
{{< image src="foresta_innevata.webp" alt="Percorso tra gli alberi per raggiungere l'allevamento degli Husky e delle renne" caption="" >}}

A cercare in giro l'esperienza invece questa volta pareva che meno di 250€ a persona fosse impossibile da spendere.
I prezzi che ricordavo erano pur sempre di 10 anni fa, e negli ultimi 10 anni il mondo è cambiato radicalmente più volte per cui avevo ragione di ritenere che sarebbe stato quasi impossibile trovare gli stessi prezzi.

{{< image src="preparativi_winterproof.webp" alt="due figure femminili si aiutano nel vestirsi" caption="Aiutarsi" >}}

E invece no!

La tenacia di {{< affiliate_link "frupari-instagram" "@frupari" >}} è stata ricompensata e ci ha permesso di fare la stessa esperienza per appena 135€ a testa.

{{< image src="casa_foresta_neve.webp" alt="casa con le luci all'esterno accese nella campagna vicino all'allevamento degli Husky e delle renne" caption="" >}}

Si tratta del {{< external_link "https://maps.app.goo.gl/LPt3AuaEpP71Qt657" "Polar Lights Tours" >}} e per la prenotazione ci siamo affidati a {{< external_link "https://www.getyourguide.com" "GetYourGuide.com" >}} ed abbiamo optato per questa esperienza: {{< external_link "https://www.getyourguide.com/it-it/sirkka-l139331/levi-combo-artico-giro-in-husky-e-renne-t503967/" "Combo artico: giro in husky e renne" >}}

{{< youtube id="lIpS5mk8LN4" caption="Visita alla farm degli husky e delle renne">}}
...
{{< image src="motoslitta.webp" alt="motoslitta" caption="" >}}

Riesco a immaginare a fatica un giro sugli Husky più lungo o una permanenza sulla slitta delle renne maggiore con le temperature esterne intorno ai -15°C (che sei d'accordo siano più tollerabili dei -15°C vissuti in altri contesti come esempio a [Tallinn]({{< ref "/racconti-di-viaggio/repubbliche-baltiche/tallinn-riga/ep-2-the-times-we-had/index.md" >}}), in cui il clima umido peggiorava decisamente la percezione della temperatura) — che fanno desiderare dopo poco di rinchiudersi al caldo a sorseggiare del tè.

{{< image src="fuoco.webp" caption="Fuoco e tepore" >}}

All'esterno le varie pellicce di renna dovrebbero scaldare ma in verità scaldano poco.
Sicuramente arredano.

{{< image src="foresta_pelliccia_renna.webp" alt="pellicce di renna appese; sullo sfondo tre persone si allontanano e si addentrano nella foresta innevata" caption="" >}}
...
È esattamente come la ricordavo, e riviverla con gli occhi di {{< affiliate_link "washington-instagram" "@washington_giò" >}} e {{< affiliate_link "frupari-instagram" "@frupari" >}} che invece non l'avevano mai vissuta è stato essenzialmente come rivivere per la prima volta.

Gli Husky non vedono l'ora di correre: sono nati per correre e appena vedono la strada libera scattano.

{{< image src="husky.webp" alt="" caption="Husky" >}}
...
[Nella volta precedente]({{< ref "racconti-di-viaggio/lapponia/verso-lapponia-casa-di-babbo-natale/index.md#i-giorni-successivi-giro-con-gli-husky" >}}) a parità di Husky (6) le persone da trasportare erano due; questa volta invece tre.

{{< image src="husky_slitta.webp" alt="preparativi per legare gli Husky alla fune da traino della slitta" caption="" type="wide-screen" >}}

Poiché dispari ho fatto l'ultimo viaggio ed era palese come fossero decisamente stanchi; peraltro a nulla è servito chiedere di poter fare il giro con {{< affiliate_link "washington-instagram" "@washington_giò" >}} (che lo aveva già fatto): la risposta del condottiero è stata **no**; una mercificazione dell'esperienza volta a tutti i costi al guadagno personale, a discapito delle persone, che mi è dispiaciuta.

{{< image src="husky_slitta_2.webp" alt="slitta trainata da sei Husky si allontana con una persona a bordo" caption="" >}}
...
{{< image src="husky_slitta_3.webp" alt="" caption="Sei husky ed una slitta" >}}
...
{{< video src="husky.webm" caption="POV: sei su una slitta trainata dagli husky in una foresta lappone" type="vertical_9x16" >}}
...
{{< video src="renne.webm" caption="POV: ti concedi un minuto di riflessione su una slitta trainata da renne" type="vertical_9x16" >}}
...
{{< image src="renna.webp" alt="Renna" caption="" >}}
...
{{< image src="slitta_renne.webp" alt="Slitta delle renne" caption="" >}}

Il giro con le renne è un'esperienza diametralmente opposta rispetto a quello con gli Husky: con gli Husky predomina la velocità, il vento ghiacciato sulla faccia, gli alberi che velocissimi scorrono ai lati del percorso.
Il tour sulla slitta trainata dalle renne è un giro di riflessione, di pace e di ragionamento sull'esperienza che si sta vivendo, sull'ambiente surreale in cui si è proiettati.

{{< image src="slitta_renne_2.webp" alt="" caption="Alba, slitta e renne" >}}
...
{{< image src="passeggiata_neve_farm.webp" alt="" caption="@frupari si allontana con gli addetti della farm" type="wide-screen" >}}
...
{{< video src="fuoco.webm" caption="Fuoco" type="vertical_9x16" >}}

### Ristoranti

Il resto del pomeriggio (praticamente le ore buie) lo passiamo in giro per Levi, un po' in centro e un po' ad esplorare la periferia che è composta prevalentemente da strade che intrecciano altre strade disperse in una foresta infinita di conifere e altri alberi con le cime innevate.
Il tutto però non ha l'aspetto di un posto abbandonato e anzi ogni incrocio è spesso ben illuminato.
Esploriamo i dintorni nella **speranza di vedere nuovamente l'_Aurora boreale_** — invano.
...
Ma per accompagnare la birra locale, ho dovuto necessariamente prendere un filetto di renna, che per impiattamento e sapore mi ha ricordato tantissimo quello mangiato a [Bergen, in Norvegia]({{< ref "/racconti-di-viaggio/norvegia/2021/day-1-bergen/index.md" >}}).

{{< image src="cena_levi_2.webp" alt="" caption="Hamburger di alce" >}}
...
Mi danno però un numero di telefono da contattare — che ci avrebbe risolto il problema alla cifra forfetaria di 250 €.
Mi suggeriscono però di aspettare il giorno dopo e di provare a chiedere al giardiniere dell'hotel, che forse disponeva di un cavo da traino e che forse mi avrebbe potuto aiutare. Unico problema: sarebbe arrivato dopo le 10 — e noi non avevamo così tanto tempo per aspettare, considerato anche il fatto che non era detto che avrebbe risolto il problema 😔
...
Finché alle 6:10, sveglio per altri motivi, pensieroso — comunque sotto il piumone — vedo il lampeggianti arancioni di quello che penso subito essere un mezzo dal lavoro.
Poiché nel soppalco intimo, con un urlo, a {{< affiliate_link "frupari-instagram" "@frupari" >}} di uscire per strada e verificare se fosse una ruspa e, in caso, fermarla — per darmi il tempo di vestirmi e scendere!

{{< image src="ruspa_stop.webp" alt="" caption="Prendendo accordi" >}}

Detto fatto: inforca il giaccone ed esce in ciabatte in mezzo alla neve; ferma la ruspa — adducendo non so che scusa.

Esco e spiego all'autista quanto accaduto e il fatto che non avevo cavo da traino.
In men che non si dica aveva già posizionato la ruspa dietro all'auto, tirato fuori un cavo e legato ad una sospensione dell'auto.

{{< image src="auto_neve.webp" alt="" caption="Mi assicuro tutto avvenga in sicurezza" >}}

Il resto della storia è contenuta in questo video 🎉

{{< youtube id="BzLnbtwey1M" caption="Siamo salvi">}}
...
{{< image src="casa_babbo_natale.webp" alt="Lanterne ed edifici nella casa di Babbo Natale a Romy" >}}

I ricordi non mi hanno smentito, avendolo trovata però questa volta ancor più commerciale, sterile e quasi senza anima.

{{< image src="casa_babbo_natale_indicazioni.webp" alt="" caption="Indicazioni per Babbo Natale" >}}
...
{{< image src="casa_babbo_natale_termometro.webp" alt="" caption="Termometro" >}}

L'obelisco in cui è situato il termometro, con i riferimenti al _Circolo Polare Artico_, è quanto di più iconico nella mente si faccia strada — in coloro che sognano di visitare la terra di Babbo Natale.

{{< box "blue" >}}
Volete sempre essere aggiornati sulle condizioni meteo del Villaggio di Babbo Natale?

A {{< external_link "https://www.visitfinland.com/en/practical-tips/live-from-finland/" "questo link" >}} uyna web-cam accesa 27/7 vi aggiornerà sul meteo e su quanta gente sia presente nella piazza principale del villaggio!
{{< /box >}}
...
Appena arriviamo in stazione, la prima grande delusione: non è una stazione con tanto di terminal, poltrone comode e una sala di aspetto in cui aspettare comodamente l'arrivo del bus, segnalato da tecnologici display.
È un piazzale, un parcheggio con al centro una pensilina e qualche seduta in cemento freddo in cui attendere. Non un servizio igienico, non un bar, niente di niente nel raggio di centinaia di metri.
...
{{< image src="bus_notte_strada.webp" alt="Bus che avanza nella notte" caption="" >}}
...
{{< image src="helsinki_station.webp" alt="" caption="Piazza della Stazione di Helsinki" type="wide-screen" >}}
...
{{< image src="helsinki_harbour.webp" alt="" caption="Vie del porto" type="wide-screen" >}}
...
{{< image src="helsinki_catedrale.webp" alt="" caption="Cattedrale di Helsinki" >}}
...
{{< image src="helsinki_public_wc.webp" alt="" caption="Toilette pubblica" >}}
...
{{< image src="helsinki_tram.webp" alt="" caption="Tram urbano" >}}
...
Di Riga ho già [parlato più volte]({{< ref "/racconti-di-viaggio/repubbliche-baltiche/vilnius-riga/ep-3-riga/index.md" >}}), e l'ho descritta sia nel [periodo invernale]({{< ref "/racconti-di-viaggio/repubbliche-baltiche/tallinn-riga/ep-3-riga/index.md" >}}) sia nel [periodi estivo]({{< ref "/racconti-di-viaggio/europe-birthday-trip-2023/ep-4-riga/index.md" >}}).

È sempre uguale, sempre piacevole, sempre una fucina di esperienze e di eterno tornare. Ma mentre {{< affiliate_link "washington-instagram" "@washington_giò" >}} ormai è quasi di casa quanto il sottoscritto — per {{< affiliate_link "frupari-instagram" "@frupari" >}} era la sua prima volta e vedere quel tripudio di mercatini e di cibo per strada è stata un'esperienza credo indimenticabile. Anche se questa volta, a differenza delle altre — non c'era la neve.

{{< image src="riga_vie.webp" alt="Viuzze di riga" caption="" >}}

E Riga d'inverno, senza neve, ammetto sia un po' spoglia.

{{< image src="riga_edificio.webp" alt="" caption="Simmetrie" >}}

Il teatro, i mercatini natalizi delle bancarelle di cibo e ancora una volta la {{< external_link "https://maps.app.goo.gl/YtLmGoXLB3P8TpZK9" "Piazza della Cattedrale di Riga" >}}.

{{< image src="riga_market_food.webp" alt="Street food con aringhe fritte e patate" caption="" >}}

Si intravede qualche stand nuovo e originale — come quello dei bicchieri in ghiaccio in cui servono dell'ottimo _balsam_ di Riga.

{{< image src="riga_markets.webp" alt="" caption="Mercatini di Natale di Riga" >}}

Il cibo però questa volta mi ha un po' deluso: forse per giorno, ma non c'era la **zuppa di pesce**.

{{< image src="riga_segnali_fumo.webp" alt="" caption="Preparativi per la cena" >}}
...
{{< image src="riga_market_food_pano.webp" alt="" caption="Street food e vin brulè" >}}