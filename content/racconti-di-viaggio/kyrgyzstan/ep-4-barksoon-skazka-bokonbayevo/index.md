...
{{< image src="jety_oguz_sanatorio_cartello.jpg" alt="" caption="" >}}
...
{{< image src="rocce_rosse_2.jpg" alt="" caption="" type="wide-screen" >}}

* * *

Ed è su questo tratto di strada, esattamente **dentro il villaggio di Jety Oguz** che **si consuma il dramma**.

{{< image src="landcruiser_incidente.jpg" alt="" caption="" type="wide-screen" >}}

Mi ritrovo a dover viaggiare all'interno di una mandria di mucche e buoi, sterminata, che occupavano non solo la carreggiata ma pure le cunete laterali. Segunedo gli altri automobilisti local, mi cimento in uno slalom delle bestie finchè, per scansarne (lentamente)...non finisco dentro un fosso!
...
{{< image src="valle_barskoon_2.jpg" alt="" caption="" type="wide-screen" >}}
...
{{< image src="valle_barskoon.jpg" alt="" caption="" >}}
...
{{< image src="small_barskoon.jpg" alt="" caption="" >}}
...
{{< image src="percorso_skazka_2.jpg" alt="" caption="" >}}
...
{{< image src="skazka_canion.jpg" alt="" caption="" type="wide-screen" >}}
...
{{< image src="skazka_canion_2.jpg" alt="" caption="" type="wide-screen" >}}
...
{{< image src="skazka_canion_dettaglio.jpg" alt="" caption="" type="wide-screen" >}}
...
{{< image src="skazka_canion_rocce_dolci.jpg" alt="" caption="" >}}

Il costo? _50 som_ (circa 0.50€)

{{< image src="skazka_canion_cartello_ingresso.jpg" alt="" caption="" >}}
...
{{< image src="skazka_rocce_rosse.jpg" alt="" caption="" type="wide-screen" >}}
...
{{< image src="skazka_canion_selfie_vertical.jpg" alt="" caption="" >}}

Notevole la presenza della toilete nei paraggi del parcheggio.

{{< image src="toilete_skazka.jpg" alt="" caption="" >}}
...
{{< image src="skazka_issykkul_view.jpg" alt="" caption="" type="wide-screen" >}}
...
{{< image src="landcruise_skazka.jpg" alt="" caption="" >}}
...
{{< image src="skazka_iurta_red.jpg" alt="" caption="" >}}
...
{{< image src="skazka_canion_percorsi.jpg" alt="" caption="" >}}
...
{{< image src="kompot_skazka.jpg" alt="" caption="" >}}
...
{{< image src="issykkul_tramonto_direzione_tong.jpg" alt="" caption="" type="wide-screen" >}}
...
{{< image src="issykkul_tramonto_direzione_tong_land_cruise.jpg" alt="" caption="" type="wide-screen" >}}
...
{{< image src="land_cruise.jpg" alt="" caption="" >}}
...
{{< image src="milky_way.jpg" alt="" caption="" >}}
...
{{< image src="milky_way_3.jpg" alt="" caption="" >}}
...
{{< image src="montagne_alba.jpg" alt="" caption="" >}}
...
{{< image src="tong_iurt_camp_alba.jpg" alt="" caption="" >}}

Le foto mostrano l'alba — ahimè non le emozioni.

{{< image src="iurt_camp_alba.jpg" alt="" caption="" type="wide-screen">}}
...
{{< image src="iurta_montagna.jpg" alt="" caption="" >}}
...
{{< image src="iurta_colazione.jpg" alt="" caption="" >}}
...
{{< image src="issykkul_cartello.jpg" alt="" caption="" >}}
