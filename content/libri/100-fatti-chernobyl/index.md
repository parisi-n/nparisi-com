...
` `  
{{< capital_letter_open >}}
Nell'[ultimo viaggio a Kiev]({{< ref "/racconti-viaggio/ucraina/kiev/ep-1-passeggiata-per-kiev">}}), mentre passeggiavo con le mani in tasca lungo la [via Khreschatyk]({{< ref "/racconti-viaggio/ucraina/kiev/ep-1-passeggiata-per-kiev" >}}), sono incappato in un negozietto di souvenir un po' diverso dagli altri, motivo per cui decisi di entrare per vedere cosa offriva di _alternativo_.
...
All'interno è conservato dal 2003 un dipinto consacrato nella [Kiev-Pechersk Lavra]({{< ref "/racconti-viaggio/ucraina/kiev/ep-2-museo-guerra-grotte" >}}) che raffigura al centro Gesù, ai suoi lati l'Arcangelo Michele e la Vergine Maria.
...
Un'altra celebrità della _Exclusion zone_ è il **Pescegatto** presente nell'acqua del canale che dalla [Torre di Raffreddamento]({{< ref "/racconti-viaggio/ucraina/kiev/ep-3-tour-chernobyl" >}}) portava l'acqua nel NPP. Il suo nome era **Borka**.
